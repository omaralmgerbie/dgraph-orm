    ...
    Query.prototype._where = function (type, field, value, name) {
        ...
        switch (type) {
            ...
            case methods_1.default.near:
                _where = "(func: " + methods_1.default.near + "(" + field + ", [" + value.longitude + ", " + value.latitude + "], " + value.distance + "){{ORDER}}{{LIMIT}})";
                break;
            case methods_1.default.contains:
                _where = "(func: " + methods_1.default.contains + "(" + field + ", [" + value.longitude + ", " + value.latitude + "]){{ORDER}}{{LIMIT}})";
                break;
        }
        return _where;
    };
