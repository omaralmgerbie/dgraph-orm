...
var Model = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _user = _b.sent();
                        _data = null;
                        if (params.field.length === 1 &&
                            _user[0][params.field[0]] &&
                            _user[0][params.field[0]].length > 0) {
                            _attributes_1 = params.attributes && params.attributes[params.field[0]]
    ...
    /**
       ...
       * @returns Promise<new>
       */
    Model.prototype.var = function (queries) {
        return __awaiter(this, void 0, void 0, function () {
            var _nestQuery;
            var _this = this;
            return __generator(this, function (_b) {
                _nestQuery = [];
                queries.forEach(function (_b, index) {
                    var type = _b.type, field = _b.field, _c = _b.value, value = _c === void 0 ? null : _c, _d = _b.params, params = _d === void 0 ? null : _d;
                    if (type === methods_1.default.uid || type === methods_1.default.has) {
                        params = value;
                        value = field;
                    }
                    else if (type === methods_1.default.type) {
                        field = _this.schema.name;
                        params = value;
                    }
                    var _params = _this._validate(_this.schema.original, params);
                    var query = new query_1.default(type, field, value, _params, index === 0 ? _this.schema.name : "var", _this._logger, true);
                    // console.log(query.query);
                    _nestQuery.push(query.query);
                    // return this._execute(query.query);
                });
                console.log(_nestQuery.reverse().join(''));
                return [2 /*return*/, this._execute("{" + _nestQuery.reverse().join('') + "}")];
            });
        });
    };
    /**
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _b.sent();
                        return [2 /*return*/, reject({ message: _unique_check })];
                    case 4:
                        mu.setCommitNow(true);
                        return [4 /*yield*/, _txn.mutate(mu)];
                    case 5:
                        _mutation = _b.sent();
                        _uid = _mutation.array[11][0][1];
    ...
    Model.prototype._check_attributes = function (original, data, isUpdate, isRelation) {
        ...
        if (!Array.isArray(data)) {
            attributes = Object.keys(data).filter(function (value, index, arr) {
                return value != "uid";
            });
            haveData = true;
        }
        ...
        for (var _i = 0, attributes_1 = attributes; _i < attributes_1.length; _i++) {
            ...
            else if (typeof original[attribute] === "object" &&
    ...
    Model.prototype._validate = function (original, params) {
        ...
        if (params.include) {
            for (var _i = 0, _b = Object.keys(params.include); _i < _b.length; _i++) {
                var relation = _b[_i];
                var unSkip = typeof params.include[relation].override === "undefined";
