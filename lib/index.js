...
exports.Query = exports.methods = exports.DgraphClient = exports.Dgraph = void 0;
/**
 * Operation
 *
...
Object.defineProperty(exports, "DgraphClient", { enumerable: true, get: function () { return dgraph_js_1.DgraphClient; } });
/**
 * Schema
 *
...
var DgraphORM = /** @class */ (function () {
     ...
     * @returns Model
     */
    DgraphORM.prototype.model = function (schema, connection) {
        this._set_model(schema);
        return new model_1.default(schema, this.models, connection !== null && connection !== void 0 ? connection : this.connection, this._log.bind(this));
    };
    /**
     * connect
     *
